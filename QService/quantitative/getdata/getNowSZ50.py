...
class threadSZ50(threading.Thread):
    ...
    def run(self):
        while self.__running.isSet():
            ...
            df[['open','price','high','low','volume','amount','date','time']].to_sql('sz50_now_data',engine,if_exists='append')
            print df  
            time.sleep(1)
...
def deleteAll_job():
    engine.execute("truncate table sz50_now_data")
